...
public class RSATest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] signedDigest = RSA.encrypt(digest, privateKey);
        ...
        byte[] decryptedSignedDigest = RSA.decrypt(signedDigest, publicKey);
        ...
        System.out.println(
                "Arrays.equals(digest, decryptedSignedDigest): " + Arrays.equals(digest, decryptedSignedDigest));
    }
}